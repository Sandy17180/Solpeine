...
export default function LifestyleGenre() {
  ...
  const prevImage = () => {
    setCurrentIndex((prev) => (prev === 0 ? LifestyleImages.length - 1 : prev - 1));
  };
  ...
  const currentImage = LifestyleImages[currentIndex];
